  ...
  return (
    <View style={{ position: "absolute", bottom: 16, left: 40, right: 40, borderTop: "0.5px solid #E5E7EB", paddingTop: 6 }} fixed>
      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Link src="https://wunderbardigital.com/?utm_source=wunderbrand_app&utm_medium=pdf_footer&utm_campaign=report_delivery&utm_content=blueprint_plus_document" style={{ fontSize: 7, color: "#07B0F2", textDecoration: "none" }}>wunderbardigital.com</Link>
      </View>
      {businessName && (
