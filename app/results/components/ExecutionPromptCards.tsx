                ...
                {locked ? (
                  <div className="rounded-lg border border-brand-border bg-slate-50 p-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link
                        href="https://wunderbardigital.com/talk-to-an-expert?utm_source=wunderbrand_app&utm_medium=execution_prompt_card&utm_campaign=nav_cta_secondary&utm_content=talk_expert"
                        target="_blank"
