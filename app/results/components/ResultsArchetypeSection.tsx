        ...
        <div className="min-w-0 flex-1">
          ...
          {!hasSnapshotPlus ? (
            <>
              ...
              <Link
                href="/checkout/snapshot-plus?utm_source=wunderbrand_app&utm_medium=results_cta&utm_campaign=snapshot_plus_upgrade&utm_content=archetype_results_overview"
