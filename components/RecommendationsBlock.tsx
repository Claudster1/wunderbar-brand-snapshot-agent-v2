        ...
        <div className="animate-fade-in-up animation-delay-800">
          ...
          {hasMore && (
            <p className="bs-small text-brand-muted mt-4">
              ...
              <Link href="/checkout/snapshot-plus?utm_source=wunderbrand_app&utm_medium=results_cta&utm_campaign=snapshot_plus_upgrade&utm_content=recommendations_block" className="text-brand-blue font-bold hover:underline focus:outline-none focus:ring-2 focus:ring-brand-blue focus:ring-offset-2 rounded">
                Snapshot+™
              </Link>
