...
// React-PDF template for WunderBrand Snapshot™ reports
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        {/* Header */}
        <Text style={styles.header}>Your WunderBrand Snapshot™</Text>
        ...
        <View style={styles.section}>
          <Text style={{ fontSize: 32, marginBottom: 40 }}>
            WunderBrand Score™: <Text style={{ fontWeight: 'bold' }}>{brand_alignment_score || 0}</Text>
          </Text>
        </View>
