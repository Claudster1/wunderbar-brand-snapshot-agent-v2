...
export function SnapshotPlusCTA({ pillar }: { pillar: string }) {
  return (
    <section className="cta-card">
      ...
      <Link href="/checkout/snapshot-plus?utm_source=wunderbrand_app&utm_medium=results_cta&utm_campaign=snapshot_plus_upgrade&utm_content=snapshot_plus_cta" className="btn-primary mt-4">
