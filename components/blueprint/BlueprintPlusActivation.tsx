    ...
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      {coverage && shouldShowSnapshotPlusUpgrade(coverage, hasSnapshotPlus) && (
        <div className="mt-8 rounded-xl border p-6 bg-slate-50">
          ...
          <Link
            href="/checkout/snapshot-plus?utm_source=wunderbrand_app&utm_medium=results_cta&utm_campaign=snapshot_plus_upgrade&utm_content=blueprint_plus_activation"
