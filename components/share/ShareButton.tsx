    ...
    return (
      <button
        ...
        style={{
          ...
          padding: "5px 12px",
          borderRadius: 5,
          border: `1px solid ${state === "copied" ? GREEN : state === "error" ? BORDER : BLUE}`,
          background: state === "copied" ? "#F0FFF4" : state === "error" ? WHITE : BLUE,
          color: state === "copied" ? GREEN : state === "error" ? "#DC2626" : WHITE,
          fontWeight: 600,
          fontSize: 12,
  ...
  return (
    <button
      ...
      style={{
        ...
        height: 36,
        borderRadius: 5,
        border: `1.5px solid ${state === "copied" ? GREEN : state === "error" ? BORDER : BLUE}`,
        background: state === "copied" ? "#F0FFF4" : state === "error" ? WHITE : BLUE,
        color: state === "copied" ? GREEN : state === "error" ? "#DC2626" : WHITE,
        cursor: state === "loading" ? "wait" : "pointer",
        transition: "all 0.15s",
