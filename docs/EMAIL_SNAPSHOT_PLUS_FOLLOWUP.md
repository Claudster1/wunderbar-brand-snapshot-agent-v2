# Email: WunderBrand Snapshot+™ Follow-up

## Purpose
Follow-up email sent after user reviews their WunderBrand Snapshot™ results, highlighting their primary pillar and introducing Snapshot+™.

## Timing
Recommended: 1-2 days after WunderBrand Snapshot™ completion
...
When you reviewed your WunderBrand Snapshot™, one pillar stood out as your primary focus area:
{{primary_pillar}}
...
WunderBrand Snapshot+™ expands on your results with deeper insight and prioritized next steps.
...
- **Primary Pillar** (Text field) - Stores the user's primary focus pillar from their WunderBrand Snapshot™
