  ...
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.paragraph}>
        ...
        Generated by Wundy, your Brand Snapshot™ assistant.
      </Text>
    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.ctaBox}>
        <Text style={styles.ctaTitle}>Upgrade to Snapshot+™</Text>
        <Text style={styles.ctaText}>
          Get a full 10-page strategic brand analysis, custom positioning
          recommendations, and a roadmap tailored to your goals — all built from
          your Brand Snapshot™ data.
        </Text>
        <Text style={styles.ctaText}>
          Your report already uncovered the gaps. Snapshot+™ shows you exactly
          how to close them.
        </Text>
      </View>
