...
const s = StyleSheet.create({
  ...
  h1: { fontSize: 19, fontWeight: "bold", color: pdfTheme.colors.navy, marginBottom: 8 },
  h2: { fontSize: 13, fontWeight: "bold", color: pdfTheme.colors.navy, marginBottom: 5, marginTop: 10 },
  body: { fontSize: 10, marginBottom: 5, lineHeight: 1.6, color: pdfTheme.colors.text },
  card: {
