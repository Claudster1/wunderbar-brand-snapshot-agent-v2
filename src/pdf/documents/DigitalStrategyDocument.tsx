...
const s = StyleSheet.create({
  ...
  h1: { fontSize: 19, fontWeight: "bold", color: pdfTheme.colors.navy, marginBottom: 8, marginTop: 18 },
  h2: { fontSize: 13, fontWeight: "bold", color: pdfTheme.colors.navy, marginBottom: 5, marginTop: 14 },
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={s.page} wrap>
        <PdfFooter businessName={brandName} productName="Digital Marketing Strategy" showPageNumbers />

        <PdfHeader title="Digital Marketing Strategy" businessName={brandName} date={printedDate} accentHex={brandAccent} />
