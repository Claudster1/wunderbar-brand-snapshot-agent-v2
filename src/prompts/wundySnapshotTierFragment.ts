...
• Target roughly **10–14 user answers** then wrap — do **not** grind through the full playbook.
...
• Required when pending: **business model**, **audience (B2B/B2C)**, **industry**, **geographic scope**, **website**, **social**, **primary acquisition**, **competitive pressure**, **offer clarity**, **customer proof**.
• **Do not** force role, years in business, or visual confidence on Snapshot (acknowledge if volunteered).
